...
def includeme(config):
    ...
    config.add_route('likes', '/likes', factory=RootResource)
    config.add_route('register', '/register')
    config.add_route('login', '/login')
    config.add_route('logout', '/logout', factory=RootResource)
    config.add_route('show_photos', '/',factory=RootResource)
    config.add_route('photos', '/photos/{page}', factory=RootResource)